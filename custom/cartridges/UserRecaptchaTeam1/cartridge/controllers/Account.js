...
server.replace(
    ...
    function (req, res, next) {
        ...
        Logger.error("gajendra registration")
        ...
        var Recaptchatoken=registrationForm.customer.recaptcha.htmlValue;
        ...
        if (!output) {
            registrationForm.customer.verifyRecaptcha.valid=false;
            registrationForm.customer.verifyRecaptcha.error="Please Verify You are Human";
