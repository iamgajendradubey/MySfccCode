...
function customCalculate(params) {
    if (params) {
        return true;
    } else {
        return false;
...
function customTestAddition(para1,para2) {
    var res= para1+para2;
    return res;
}
...
describe('cartHelpers', function () {
    ...
    it('should return boolean', function () {
        var res = customCalculate(5);
        // assert.isTrue(res);
        assert.isBoolean(res);
    });

    it('should return currect sum',function (){
        var res=customTestAddition(3,2);
        assert.strictEqual(res,5,"must equal");
    });

    it('should return owner name',function (){
        var a= require("../../../../../../custom/cartridges/gajendra_cartridge2/cartridge/scripts/helpers/customTesthelper.js");
        var res=a.OwnerName("gajendra");
        assert.strictEqual(res,"gajendra","owner is right");
    });  
