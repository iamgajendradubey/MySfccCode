...
function getProfile(profile) {
    ...
    if (profile) {
        result = {
            ...
            password: '********',
            skintone:profile.custom.gajendraSkintone,
            haircolor:profile.custom.gajendraHairColor,
            skintype:profile.custom.gajendraSkinType,
            eyecolor:profile.custom.gajendraEyeColor,
        };
    } else {
        result = null;
    }
