...
function search(req, res) {
    ...
    if(customer.authenticated && customer.isMemberOfCustomerGroup('Above18year')){
        apiProductSearch.search();
    }
    else if(customer.authenticated && customer.isMemberOfCustomerGroup('below18year')){
        apiProductSearch.addRefinementValues('isAdult',false);
        apiProductSearch.search();
...
//     if(customer.authenticated && customer.isMemberOfCustomerGroup('Above18year')) {
//         if(customer.authenticated && customer.isMemberOfCustomerGroup('below18year')) {
//         apiProductSearch.addRefinementValues('isAdult',false);
        
//         // apiProductSearch.removeRefinementValues('for18+',false);
//     }
//     apiProductSearch.addRefinementValues('isAdult',true);
//     // apiProductSearch.search();        
//     }
// else{
