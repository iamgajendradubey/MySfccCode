...
//...........................................new sanjeev sir assingment...............

// if (LoyalityPoints >0 && LoyalityPoints <=100) {
    var newLogger= Logger.getLogger('gold,Gold');
    newLogger.error("gajendra Gold");  
// }
// else if (LoyalityPoints >100 && LoyalityPoints <=300) {
//     var newLogger= Logger.getLogger('diamond,Diamond');
//     newLogger.error('gajendra customer no- '+ customerNo +'is charge is 20%');
// }
// else{
//     var newLogger= Logger.getLogger('platinum,Platinum');
//     newLogger.error('gajendra customer no- '+ customerNo +'is charge is 30%');
// }
